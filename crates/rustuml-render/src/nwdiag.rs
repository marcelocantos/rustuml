...
pub fn render(diagram: &NwdiagDiagram, theme: &Theme) -> String {
    ...
    let col_cx = |col: usize| -> f64 {
        LEFT_MARGIN + NET_LABEL_W + col as f64 * COL_W + HOST_W / 2.0
    };
    ...
    // Canvas dimensions.
    let total_w =
        LEFT_MARGIN + NET_LABEL_W + num_hosts.max(1) as f64 * COL_W + LEFT_MARGIN;
