...
#ifndef YY_AAG_TMP_GRAPHVIZ_SRC_BUILD_LIB_CGRAPH_GRAMMAR_H_INCLUDED
# define YY_AAG_TMP_GRAPHVIZ_SRC_BUILD_LIB_CGRAPH_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef AAGDEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#line 29 "/tmp/graphviz-src/lib/cgraph/grammar.y"
...
#line 83 "/tmp/graphviz-src/build/lib/cgraph/grammar.h"
...
union AAGSTYPE
{
#line 125 "/tmp/graphviz-src/lib/cgraph/grammar.y"

			int				i;
			char			*str;
			struct Agnode_s	*n;

#line 119 "/tmp/graphviz-src/build/lib/cgraph/grammar.h"
...
#line 55 "/tmp/graphviz-src/lib/cgraph/grammar.y"

	/* defined in/generated by scan.l */
	void aagerror(aagscan_t, const char*);
	int aaglex(AAGSTYPE *, aagscan_t);

#line 139 "/tmp/graphviz-src/build/lib/cgraph/grammar.h"

#endif /* !YY_AAG_TMP_GRAPHVIZ_SRC_BUILD_LIB_CGRAPH_GRAMMAR_H_INCLUDED  */
