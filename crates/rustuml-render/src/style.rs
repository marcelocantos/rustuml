...
impl Theme {
    ...
    /// A modern, clean theme with cool-toned semantic colours.
    ///
    /// Inspired by Linear/Notion aesthetics: indigo-tinted class fills,
    /// slate borders, no shadows, 4px round corners. Each entity kind
    /// has a distinct but harmonious hue for quick visual scanning.
    pub fn slate() -> Self {
        Self {
            name: "slate".into(),
            sequence: SequenceStyle {
                participant_background: "#F8FAFC".into(),
                participant_border: "#334155".into(),
                lifeline_color: "#CBD5E1".into(),
                arrow_color: "#475569".into(),
                note_background: "#FFFBEB".into(),
                note_border: "#B45309".into(),
                group_border: "#64748B".into(),
                divider_color: "#94A3B8".into(),
                actor_background: "#F8FAFC".into(),
                actor_border: "#334155".into(),
                actor_font_color: "".into(),
                actor_font_size: 0.0,
                actor_font_style: "".into(),
                arrow_font_color: "#475569".into(),
                arrow_font_size: 0.0,
                arrow_font_style: "".into(),
                arrow_thickness: 1.0,
                divider_background: "#F1F5F9".into(),
                divider_border: "#94A3B8".into(),
                divider_font_color: "#475569".into(),
                divider_font_size: 0.0,
                group_background: "#F8FAFC".into(),
                group_font_color: "#1E293B".into(),
                group_font_size: 0.0,
                group_font_style: "".into(),
                group_header_font_color: "#1E293B".into(),
                group_header_font_size: 0.0,
                group_header_font_style: "".into(),
                lifeline_background: "".into(),
                lifeline_border_thickness: 0.5,
                message_align: "".into(),
                participant_border_thickness: 0.75,
                participant_font_color: "#1E293B".into(),
                participant_font_size: 0.0,
                participant_font_style: "".into(),
                participant_padding: 0.0,
                reference_background: "#FFFBEB".into(),
                reference_border: "#B45309".into(),
                reference_font_color: "#92400E".into(),
                response_message_below_arrow: false,
                box_padding: 0.0,
                group_body_background: "".into(),
                lifeline_strategy: "".into(),
            ...
            class: ClassStyle {
                class_background: "#EEF2FF".into(),
                abstract_background: "#F5F3FF".into(),
                interface_background: "#EFF6FF".into(),
                enum_background: "#ECFDF5".into(),
                border_color: "#4338CA".into(),
                stereotype_color: "#6366F1".into(),
                arrow_color: "#475569".into(),
                arrow_thickness: 1.0,
                font_size: 14.0,
                font_color: "#1E293B".into(),
                header_background: "".into(),
                attribute_font_size: 11.5,
                arrow_font_color: "#475569".into(),
                arrow_font_size: 0.0,
                arrow_font_style: "".into(),
                attribute_font_color: "#334155".into(),
                attribute_font_style: "".into(),
                attribute_icon_size: 0.0,
                ...
                font_style: "".into(),
                round_corner: 4.0,
                stereotype_font_color: "#6366F1".into(),
                stereotype_font_size: 0.0,
                stereotype_font_style: "".into(),
                stereotype_c_background: "".into(),
            },
            state: StateStyle {
                state_background: "#F0F9FF".into(),
                initial_color: "#1E293B".into(),
                border_color: "#0369A1".into(),
                arrow_color: "#475569".into(),
                arrow_font_color: "#475569".into(),
                arrow_font_size: 0.0,
                arrow_font_style: "".into(),
                ...
                attribute_font_size: 0.0,
                border_thickness: 0.75,
                end_color: "#1E293B".into(),
                font_color: "#0C4A6E".into(),
                font_name: "".into(),
                font_size: 0.0,
                font_style: "".into(),
                round_corner: 4.0,
            ...
            activity: ActivityStyle {
                action_background: "#F8FAFC".into(),
                action_border: "#334155".into(),
                decision_background: "#FEF9C3".into(),
                bar_color: "#1E293B".into(),
                start_color: "#1E293B".into(),
                stop_color: "#1E293B".into(),
                arrow_color: "#475569".into(),
                arrow_font_color: "#475569".into(),
                arrow_font_size: 0.0,
                border_thickness: 0.75,
                diamond_font_color: "#854D0E".into(),
                diamond_font_size: 0.0,
                end_color: "#1E293B".into(),
                font_color: "#1E293B".into(),
                font_name: "".into(),
                ...
                swimlane_font_size: 0.0,
                swimlane_title_font_style: "".into(),
                diamond_border_color: "#A16207".into(),
            },
            global: GlobalStyle {
                font_family: "system-ui, -apple-system, sans-serif".into(),
                font_size: 14.0,
                background_color: "#FFFFFF".into(),
                default_font_color: "#1E293B".into(),
                arrow_color: "#475569".into(),
                border_color: "#475569".into(),
            ...
            note: NoteStyle {
                background: "#FFFBEB".into(),
                border: "#B45309".into(),
                font_color: "#92400E".into(),
                font_size: 0.0,
                ..NoteStyle::default()
            },
            actor: ActorStyle::default(),
            package: PackageStyle {
                ...
                border: "#64748B".into(),
                font_color: "#334155".into(),
                ..PackageStyle::default()
            },
            component: ComponentStyle::default(),
            usecase: UseCaseStyle::default(),
            deployment: DeploymentStyle::default(),
    ...
    /// A modern, cleaner theme (Bootstrap grey palette).
    pub fn modern() -> Self {
        Self {
            name: "modern".into(),
            sequence: SequenceStyle {
